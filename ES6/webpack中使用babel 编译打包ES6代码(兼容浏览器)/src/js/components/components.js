...
const onLine=()=>{
	console.log('Hello');
	const onlineBox=document.getElementById('online_lx');
	const closeBtn=document.getElementById('online_close');
	const openBtn=document.getElementById('online_open');
...
export {goTop,topMenu,viewWidth,onLine}