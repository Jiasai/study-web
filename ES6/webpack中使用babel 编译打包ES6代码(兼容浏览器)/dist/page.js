...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_stable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/stable */ \"./node_modules/core-js/stable/index.js\");\n/* harmony import */ var core_js_stable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_stable__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _components_nav_nav_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/nav/nav.js */ \"./src/components/nav/nav.js\");\n/* harmony import */ var _components_setRemViewport_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/setRemViewport.js */ \"./src/js/components/setRemViewport.js\");\n/* harmony import */ var _components_components_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/components.js */ \"./src/js/components/components.js\");\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === \"undefined\" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it[\"return\"] != null) it[\"return\"](); } finally { if (didErr) throw err; } } }; }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n //引入 core-js处理 ES6 一些API不被编译的问题\n//引入module模块\n\n\n\n //检测是IE浏览器8/9，跳转网址\n\nif (navigator.appName == \"Microsoft Internet Explorer\" && navigator.appVersion.split(\";\")[1].replace(/[ ]/g, \"\") == \"MSIE8.0\") {\n  window.location.href = \"jianrong.html\";\n}\n\nif (navigator.appName == \"Microsoft Internet Explorer\" && navigator.appVersion.split(\";\")[1].replace(/[ ]/g, \"\") == \"MSIE9.0\") {\n  window.location.href = \"jianrong.html\";\n} //实例化执行移动端menu菜单\n\n\nnew _components_nav_nav_js__WEBPACK_IMPORTED_MODULE_1__[\"navMenu\"](_components_nav_nav_js__WEBPACK_IMPORTED_MODULE_1__[\"menuConfig\"]); //执行goTop返回顶部\n\nObject(_components_components_js__WEBPACK_IMPORTED_MODULE_3__[\"goTop\"])(); //在线客服\n\nObject(_components_components_js__WEBPACK_IMPORTED_MODULE_3__[\"onLine\"])(); //给window添加resize监听\n\nwindow.addEventListener('resize', function () {\n  Object(_components_setRemViewport_js__WEBPACK_IMPORTED_MODULE_2__[\"setRemValue\"])().then(function () {\n    //更新Rem值\n    setTimeout(function () {\n      window.location.reload(); //刷新页面\n    }, 300);\n  });\n}, false); //给window添加load监听\n\nwindow.addEventListener('load', function () {\n  //更新Rem值\n  Object(_components_setRemViewport_js__WEBPACK_IMPORTED_MODULE_2__[\"setRemValue\"])();\n  /* ------------------------------------------ */\n}, false); //window屏幕滚动事件\n\nwindow.addEventListener('scroll', function () {\n  //菜单menu吸顶\n  Object(_components_components_js__WEBPACK_IMPORTED_MODULE_3__[\"topMenu\"])();\n}, false); //阻止img默认事件\n\nvar imgDefault = function imgDefault(el) {\n  el.addEventListener('mousedown', function (e) {\n    e.preventDefault(); //阻止默认事件发生，不可以拖拽\n  }, false);\n}; //图片不可拖拽\n\n\nvar imgList = document.documentElement.querySelectorAll('img');\n\nvar _iterator = _createForOfIteratorHelper(imgList),\n    _step;\n\ntry {\n  for (_iterator.s(); !(_step = _iterator.n()).done;) {\n    var img = _step.value;\n    imgDefault(img);\n  }\n} catch (err) {\n  _iterator.e(err);\n} finally {\n  _iterator.f();\n}\n\n//# sourceURL=webpack:///./src/js/page.js?");
